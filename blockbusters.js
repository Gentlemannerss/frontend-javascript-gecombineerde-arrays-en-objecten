...
console.log(movies.length - 1);               // Een andere mogelijkheid was: const lastIndexOfMovies = movies.length -1; en dan console.log(lastIndexOfMovies);
...
console.log(movies[movies.length-1]);         // en dan hier console.log(movies[lastIndexOfMovies]);
...
const selectedMovie = movies[5]; /*verander index number of movies to change outcome.*/
